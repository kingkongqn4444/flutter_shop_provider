...
class Colors {
  ...
  Color _textDartColor = Color(0xFF606060);
  Color _textLightColor = Color(0xFF606060);
  ...
  Color textDarkColor(double opacity) {
    return this._textDartColor.withOpacity(opacity);
  }

  Color textLightColor(double opacity) {
    return this._textLightColor.withOpacity(opacity);
  }
}
