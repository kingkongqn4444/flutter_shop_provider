  ...
  BrandsList() {
    _list = [
      new Brand('Wilson', 'img/logo-03.svg', Colors.greenAccent, true, 4.3, [
        new Product("Product", 'Zogaa FlameSweater', 'img/man1.webp', 80, 42.63,
            200, 2554, 3.1, 10.5),
        new Product("Product", 'Men Polo Shirt Brand Clothing', 'img/man2.webp',
            80, 42.63, 200, 2554, 3.1, 10.5),
        new Product("Product", 'Polo Shirt for Men', 'img/man3.webp', 80, 42.63,
            200, 2554, 3.1, 10.5),
        new Product("Product", 'Men\'s Sport Pants Long Summer',
            'img/man4.webp', 80, 42.63, 200, 2554, 3.1, 10.5),
        new Product("Product", 'Men\'s Hoodies Pullovers Striped',
            'img/man5.webp', 80, 42.63, 200, 2554, 3.1, 10.5),
        new Product("Product", 'Men Double Breasted Suit Vests',
            'img/man6.webp', 80, 42.63, 200, 2554, 3.1, 10.5),
        new Product("Product", 'Puimentiua Summer Fashion', 'img/man7.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product("Product", 'Casual Sweater fashion Jacket', 'img/man8.webp',
            80, 42.63, 200, 2554, 3.1, 10.5),
      ]),
